    ...
    <div className="container max-w-2xl mx-auto space-y-6">
      ...
      <Card className="rounded-xl">
        <CardHeader>
          ...
          <CardDescription>Switch between donor and recipient modes</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select value={role} onValueChange={handleRoleChange} disabled={loading}>
                ...
                <SelectContent>
                  <SelectItem value="donor">Donor - Share food with others</SelectItem>
                  <SelectItem value="recipient">Recipient - Find food resources</SelectItem>
                </SelectContent>
              </Select>
              {loading && <p className="text-sm text-muted-foreground">Updating role...</p>}
            </div>
          </div>
        </CardContent>
      </Card>
